...
public final class LogUtil {
    ...
    public static class TextFile {
        ...
        public TextFile(final String name, final String path) {
            Fox.INSTANCE.getExecutorService().execute(() -> {
                this.file = new File(Fox.INSTANCE.getPlugin().getDataFolder() + path);
                this.file.mkdirs();
                this.file = new File(Fox.INSTANCE.getPlugin().getDataFolder() + path, name + ".txt");
                try {
